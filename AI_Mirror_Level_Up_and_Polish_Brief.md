...
| **5 --- Biometrics and style** | D (third form, the mirror's pulse), H written up | Heart, brain and stride form one continuous object |
| **6 --- Polish** | I, final Pi soak and a new transitions capture | All acceptance tests pass |
